<template>
  <nav>
    <div class="nav-wrapper orange darken-2">
      <router-link to="/" class="brand-logo">Stu Manager</router-link>
      ...
      <ul class="side-nav lime lighten-5" id="mobile-demo">
        <li v-if="isLoggedIn">
          <div class="chip">
            <img src="../assets/headerlogo.png" alt="Contact Person">
              {{currentUser}}
          </div>
        </li>
        <li v-if="isLoggedIn"><router-link to="/"><i class="fa fa-address-book i-25"></i>名單</router-link></li>
        <li v-if="!isLoggedIn"><router-link to="/register"><i class="fa fa-user-plus i-25"></i>註冊</router-link></li>
